...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_02_04_drive.jpg)<caption>A graph of position versus time for the drive to and from school is shown.</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_02_04_velocity.jpg)<caption>Graph of velocity versus time for the drive to and from school.</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_02_04_car.jpg)<caption>A graph is shown of the position of a jet-powered car during the time span when it is speeding up. The slope of a d vs. t graph is velocity. This is shown at two points. Instantaneous velocity at any point is the slope of the tangent at that point.</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_02_04_power.jpg)<caption>The graph shows the velocity of a jet-powered car during the time span when it is speeding up.</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_02_04_accurate.jpg)<caption>The graph shows a more accurate graph of the velocity of a jet-powered car during the time span when it is speeding up.</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_02_04_ve.jpg)<caption>None</caption>
