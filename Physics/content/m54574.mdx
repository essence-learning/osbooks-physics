...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_22_04_Fission.jpg)<caption>Neutron-induced fission is shown. First, energy is put into a large nucleus when it absorbs a neutron. Acting like a struck liquid drop, the nucleus deforms and begins to narrow in the middle. Since fewer nucleons are in contact, the repulsive Coulomb force is able to break the nucleus into two parts with some neutrons also flying away.</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_22_04_WatrReactr.jpg)<caption>A pressurized water reactor is cleverly designed to control the fission of large amounts of </caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_22_04_Curve.jpg)<caption>Fusion of light nuclei to form medium-mass nuclei converts mass to energy, because binding energy per nucleon ( </caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_22_04_Well.jpg)<caption>Potential energy between two light nuclei graphed as a function of distance between them. If the nuclei have enough kinetic energy to get over the Coulomb repulsion hump, they combine, release energy, and drop into a deep attractive well.</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_22_04_GunType.jpg)<caption>A gun-type fission bomb for  </caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_22_04_Injection.jpg)<caption>An implosion created by high explosives compresses a sphere of </caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_22_04_Trinity.jpg)<caption>Trinity test (1945), the first nuclear bomb (credit: U.S. Department of Energy)</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_22_04_Bomb.jpg)<caption>This schematic of a fusion bomb (H-bomb) gives some idea of how the  </caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_22_04_Tokamok.jpg)<caption>Tokamak confinement of nuclear fusion plasma. The magnetic field lines are used to confine the high-temperature plasma (purple). Research is currently being done to increase the efficiency of the tokamak confinement model.</caption>
