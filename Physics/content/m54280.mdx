...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_10_01_mirror.jpg)<caption>This is a diagram of the instrument used in the MichelsonMorley experiment.</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_10_00_Einstein.jpg)<caption>Albert Einstein (1879–1955) developed modern relativity and also made fundamental contributions to the foundations of quantum mechanics. (The Library of Congress)</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_10_01_train.jpg)<caption>Light arriving to observer A as seen by two different observers.</caption>
...
1. 
1. Earth is at rest and the sun orbits Earth.
2. The sun is at rest and Earth orbits the sun.


2. 
1. The sun is at rest and Earth orbits the sun.
