...
<table>
  <tr>
    <td>carrier particle</td>
    <td>colliding beam</td>
    <td>cyclotron</td>
    <td>Feynman diagram</td>
    <td>graviton</td>
  </tr>
  <tr>
...
The weak nuclear force is responsible for beta decay, as seen in the equation  <math display="block">
 <mrow>
  <msubsup>
   <mrow />
   <mi>Z</mi>
  ...
  <mo> </mo><mo>+</mo><mo> </mo><mi>e</mi><mo> </mo><mo>+</mo><mo> </mo><mi>v</mi><mo>.</mo>
 </mrow>
</math>  Recall that beta decay is when a beta particle is ejected from an atom. In order to accelerate away from the nucleus, the particle must be acted on by a force.   Recall that beta decay is when a beta particle is ejected from an atom. In order to accelerate away from the nucleus, the particle must be acted on by a force. **Enrico Fermi** was the first to envision this type of force. While this force is appropriately labeled, it remains stronger than the gravitational force. However, its range is even smaller than that of the strong force, as can be seen in [None](None). The weak nuclear force is more important than it may appear at this time, as will be addressed when we discuss quarks.

## Relative strength and range of the four fundamental forces
Force<sup>[1]</sup>Range<sup>[1]</sup><table>
  <tr>
    <td>Gravity</td>
    <td><math>
 <mrow>
...
The relative masses of the listed carrier particles describe something valuable about the four fundamental forces, as can be seen in [None](None). **W bosons** (consisting of  <math>
 <mrow>
  <msup>
   <mtext>W</mtext>
   <mo>−</mo>
...
</math>  bosons) and   bosons) and **Z bosons** ( <math>
 <mrow>
  <msup>
   <mtext>Z</mtext>
   <mn>0</mn>
...
ForceCarrier ParticleRange<sup>[1]</sup><sup>[1]</sup><table>
 ...
 <mrow>
  ...
  <tr>
    <td>Strong</td>
    <td>Pi mesons or pions (now known as gluons)</td>
    <td><math>
 <mrow>
  <mo>&lt;</mo><msup>
   <mrow>
...
So what do scientists think about the unfound particle? For starters, the graviton (like the photon) should be a massless particle traveling at the speed of light. This is assumed because, like the electromagnetic force, gravity is an inverse square law,  <math>
 <mrow>
  <mi>F</mi><mo>≈</mo><mfrac>
   <mn>1</mn>
   <mrow>
...
</math> . Scientists also theorize that the graviton is an electrically neutral particle, as an empty space within the influence of gravity is chargeless. . Scientists also theorize that the graviton is an electrically neutral particle, as an empty space within the influence of gravity is chargeless.
...
True or FalseGiven that their carrier particles are massless, some may argue that the electromagnetic and gravitational forces should maintain the same value at all distances from their source. However, both forces decrease with distance at a rate of  <math>
