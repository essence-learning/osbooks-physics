...
In addition to amplitude, frequency, and period, their wavelength and wave velocity also characterize waves. The **wavelength**  <math>
 <mi>λ</mi>
</math>  is the distance between adjacent identical parts of a wave, parallel to the direction of propagation. The   is the distance between adjacent identical parts of a wave, parallel to the direction of propagation. The **wave velocity**  <math>
 <mrow>
  <msub>
   <mi>v</mi>
   <mi>w</mi>
...
</math>  is the speed at which the disturbance moves.  is the speed at which the disturbance moves.
...
<equation id="fs-id1164564807684"> <math display="block">
 <mrow>
  <mi>f</mi><mo>=</mo><mfrac>
   <mn>1</mn>
   <mi>T</mi>
...
<equation id="fs-id1164566851770"> <math display="block">
 <mrow>
  <mi>T</mi><mo>=</mo><mfrac>
   <mn>1</mn>
   <mi>f</mi>
...
<equation id="fs-id1164566836508"> <math display="block">
 <mrow>
  <msub>
   <mi>v</mi>
   <mi>w</mi>
...
<equation id="fs-id1164563568005"> <math display="block">
 <mrow>
  <msub>
   <mi>v</mi>
   <mi>w</mi>
  </msub>
  <mo>=</mo><mi>f</mi><mi>λ</mi>
<mtext>.</mtext>
 </mrow>
</math>
</equation>
...
## Strategy
The values for the wavelength  <math display="block">
 <mo stretchy="false">(</mo><mi>λ</mi><mo>=</mo><mn>10.0</mn><mspace width="0.3em" /><mtext> </mtext><mi>m</mi><mo stretchy="false">)</mo>
</math>  and the period    and the period  <math>
 <mrow>
<mtext>(</mtext>
  <mi>T</mi><mo>=</mo><mn>5.00</mn><mspace width="0.3em" /><mtext>s)</mtext>
 </mrow>
</math>  are given and we are asked to find    are given and we are asked to find  <math>
 <mrow>
  <msub>
   <mi>v</mi>
   <mi>w</mi>
...
</math>  Therefore, we can use    Therefore, we can use  <math>
 <mrow>
  <msub>
   <mi>v</mi>
   <mi>w</mi>
...
</math>  to find the wave velocity.  to find the wave velocity.

## Solution
Enter the known values into  <math>
 <mrow>
  <msub>
   <mi>v</mi>
   <mi>w</mi>
...
<equation id="fs-id1164566506536"> <math display="block">
 <mrow>
  <msub>
   <mi>v</mi>
   <mi>w</mi>
  ...
  <mo>=</mo><mfrac>
   <mrow>
    <mtext>10</mtext><mtext>.0 m</mtext>
   </mrow>
   <mrow>
    <mtext>5</mtext><mtext>.00 s</mtext>
   </mrow>
  </mfrac>
  <mo>=</mo><mn>2.</mn><mspace width="0.3em" /><mtext>00 m/s</mtext><mtext>.</mtext>
 </mrow>
</math> </equation>
## Discussion
...
## Strategy FOR (A)
To find the period, we solve for  <math>
 <mrow>
  <mi>T</mi><mo>=</mo><mfrac>
   <mn>1</mn>
   <mi>f</mi>
...
</math>, given the value of the frequency  , given the value of the frequency  <math>
 <mrow>
<mtext>(</mtext>
  <mi>f</mi><mo>=</mo><mn>2</mn><msup>
   <mtext>s</mtext>
   <mrow>
    <mo>−</mo><mn>1</mn>
   </mrow>
...
## Solution for (a)
Enter the known value into  <math>
 <mrow>
  <mi>T</mi><mo>=</mo><mfrac>
   <mn>1</mn>
   <mi>f</mi>
...
<equation id="fs-id1164566865249"> <math display="block">
 <mrow>
  <mi>T</mi><mo>=</mo><mfrac>
   <mn>1</mn>
   <mrow>
  ...
  <mo>=</mo><mn>0.</mn><mspace width="0.3em" /><mtext>5 s</mtext><mtext>.</mtext>
 </mrow>
</math> </equation>
## Strategy FOR (B)
Since one definition of wavelength is the distance a wave has traveled after one complete cycle—or one period—the values for the wavelength  <math display="block">
 <mo stretchy="false">(</mo><mi>λ</mi><mo>=</mo><mn>0.9</mn><mspace width="0.3em" /><mtext> </mtext><mi>m</mi><mo stretchy="false">)</mo>
</math>  as well as the frequency are given. Therefore, we can use    as well as the frequency are given. Therefore, we can use  <math>
 <mrow>
  <msub>
   <mi>v</mi>
   <mtext>w</mtext>
...
Enter the known values into  <math>
 ...
 <mrow>
  ...
  <mo>=</mo><mi>f</mi><mi>λ</mi><mo>=</mo><mo stretchy="false">(</mo><mn>2</mn><msup>
   <mrow>
    <mtext> s</mtext>
   </mrow>
   <mrow>
  ...
  <mtext>)(0</mtext><mtext>.9 m) = 1</mtext><mtext>.8 m/s</mtext><mtext>.</mtext>
 </mrow>
</math>  

## Discussion
We could have also used the equation  <math>
 <mrow>
  <msub>
   <mi>v</mi>
   <mtext>w</mtext>
...
</math>  to solve for the wave velocity since we already know the value of the period    to solve for the wave velocity since we already know the value of the period  <math>
 <mrow>
<mtext>(</mtext>
  <mi>T</mi><mo>=</mo><mn>0.5</mn><mspace width="0.3em" /><mtext>s)</mtext>
 </mrow>
</math>  from our calculation in part (a), and we would come up with the same answer.  from our calculation in part (a), and we would come up with the same answer.
...
* <math>
 <mi>λ</mi>
</math>, which is the distance between adjacent identical parts of the wave.
* <math>
 <mrow>
  <msub>
   <mi>v</mi>
