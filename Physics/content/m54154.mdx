...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_05_05_ruler.jpg)<caption>A ruler is displaced from its equilibrium position.</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_05_05_object.jpg)<caption>An object attached to a spring sliding on a frictionless surface is a simple harmonic oscillator. When displaced from equilibrium, the object performs simple harmonic motion that has an amplitude </caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_05_05_pendulum.jpg)<caption>A simple pendulum has a small-diameter bob and a string that has a very small mass but is strong enough not to stretch. The linear displacement from equilibrium is s, the length of the arc. Also shown are the forces on the bob, which result in a net force of −</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_05_05_car.jpg)<caption>A car in a parking lot. (exfordy, Flickr)</caption>
## Strategy
