## Introduction
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_07_00_Kepler.jpg)<caption>Johannes Kepler (left) showed how the planets move, and Isaac Newton (right) discovered that gravitational force caused them to move that way. ((left) unknown, Public Domain; (right) Sir Godfrey Kneller, Public Domain)</caption>
