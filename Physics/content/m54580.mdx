...
Another other useful mass unit on the atomic scale is the  <math>
 <mrow>
  <mtext>M</mtext><mtext>e</mtext><mtext>V</mtext><mo>/</mo><msup>
   <mi>c</mi>
   <mn>2</mn>
  </msup>
  </mrow>
</math> . While rarely used in most contexts, it is convenient when one uses the equation   . While rarely used in most contexts, it is convenient when one uses the equation  <math>
 <mrow>
...
</math>, as will be addressed later in this text., as will be addressed later in this text.
...
Proton MassNeutron MassElectron Mass<table>
  <tr>
    ...
    <td><math>
 <mrow>
  <mn>1.673</mn><mspace width="0.25em" /><mo>×</mo><mspace width="0.25em" /><msup>
   <mrow>
    <mn>10</mn></mrow>
   <mrow>
    <mn>−27</mn></mrow>
    ...
    <td><math>
 <mrow>
  <mn>1.675</mn><mspace width="0.25em" /><mo>×</mo><mspace width="0.25em" /><msup>
   <mrow>
    <mn>10</mn></mrow>
   <mrow>
    <mn>−27</mn></mrow>
    ...
    <td><math>
 <mrow>
  <mn>9.109</mn><mspace width="0.25em" /><mo>×</mo><mspace width="0.25em" /><msup>
   <mrow>
    <mn>10</mn></mrow>
   <mrow>
    <mn>−31</mn></mrow>
 ...
 <mrow>
  <mn>1.009</mn></mrow>
    ...
    <td><math>
 <mrow>
  <mn>5.486</mn><mspace width="0.25em" /><mo>×</mo><mspace width="0.25em" /><msup>
   <mrow>
    <mn>10</mn></mrow>
   <mrow>
    <mn>−4</mn></mrow>
...
To more easily identify various atoms, their atomic number and mass number are typically written in a form of representation called the **nuclide**. The nuclide form appears as follows: <math>
<msubsup>
<mrow />
   <mrow><mi>A</mi></mrow>
   <mi>Z</mi>
...
</math>, where , where *X* is the atomic symbol and *N* represents the number of neutrons. 

Let us look at a few examples of nuclides expressed in the  <math>
<msubsup>
<mrow />
   <mrow><mi>A</mi></mrow>
   <mi>Z</mi>
...
</math>  notation. The nucleus of the simplest atom, hydrogen, is a single proton, or    notation. The nucleus of the simplest atom, hydrogen, is a single proton, or  <math>
 <mrow>
  <mmultiscripts>
   <mtext>H</mtext>
   <mprescripts />
...
</math> (the zero for no neutrons is often omitted). To check the symbol, refer to the periodic table—you see that the atomic number  (the zero for no neutrons is often omitted). To check the symbol, refer to the periodic table—you see that the atomic number *Z *of hydrogen is 1. Since you are given that there are no neutrons, the mass number *A* is also 1. There is a scarce form of hydrogen found in nature called *deuterium*; its nucleus has one proton and one neutron and, hence, twice the mass of common hydrogen. The symbol for deuterium is, thus,  <math>
<msubsup>
<mrow />
   <mrow><mn>1</mn></mrow>
   <mn>2</mn>
...
</math> . An even rarer—and radioactive—form of hydrogen is called  . An even rarer—and radioactive—form of hydrogen is called *tritium*, since it has a single proton and two neutrons, and it is written  <math>
<msubsup>
<mrow />
   <mrow><mn>1</mn></mrow>
   <mn>3</mn>
...
</math> . The three varieties of hydrogen have nearly identical chemistries, but the nuclei differ greatly in mass, stability, and other characteristics. Again, the different nuclei are referred to as isotopes of the same element. . The three varieties of hydrogen have nearly identical chemistries, but the nuclei differ greatly in mass, stability, and other characteristics. Again, the different nuclei are referred to as isotopes of the same element.
...
<equation id="fs-id1164565288066"> <math display="block">
 <mrow>
  <msup>
   <mrow />
   <mi>A</mi>
...
which is sufficient and is most commonly used. For example, in this simpler notation, the three isotopes of hydrogen are  <math>
 <mrow>
  <msup>
   <mrow />
   <mn>1</mn>
 ...
 <mrow>
  ...
  <mtext>U</mtext></mrow>
</math>, should we need to know, we
can determine that , should we need to know, we
...
</math>  It was soon evident that Becquerel’s rays originate in the nuclei of the atoms and have other unique characteristics.  It was soon evident that Becquerel’s rays originate in the nuclei of the atoms and have other unique characteristics.
...
<equation id="fs-id1164567138801"> <math display="block">
 <mrow>
  <mi>r</mi><mo>=</mo><msub>
   <mi>r</mi>
   <mi>o</mi>
...
where  <math>
 <mrow>
  ...
  <mo>=</mo></mrow>
</math> 1.2 femtometer (fm) and  1.2 femtometer (fm) and *A *is the mass number of the nucleus.
...
Note that  <math>
 <mrow>
  ...
  <mo>∝</mo><mi>A</mi></mrow>
</math> . Since many nuclei are spherical, and the volume of a sphere is   . Since many nuclei are spherical, and the volume of a sphere is  <math>
 <mrow>
...
</math>, we see that  , we see that  <math>
 <mrow>
...
<equation id="fs-id1164566003648"> <math display="block">
 <mrow>
  <mmultiscripts>
   <mi>X</mi>
   <mprescripts />
  ...
  <mrow><mo>→</mo></mrow><mmultiscripts>
   <mi>Y</mi>
   <mprescripts />
   <mrow>
    <mi>Z</mi><mo>−</mo><mn>2</mn></mrow>
   <mrow>
    <mi>A</mi><mo>−</mo><mn>4</mn></mrow>
  </mmultiscripts>
  <msub>
   <mrow />
   <mi>N</mi>
...
<equation id="fs-id1164565502588"> <math display="block">
 <mrow>
  <msubsup>
   <mrow />
   <mrow><mi>Z</mi></mrow>
...
Write the complete decay equation in  <math>
<msubsup>
<mrow />
   <mrow><mi>Z</mi></mrow>
   <mi>A</mi>
...
</math>  notation for beta decay producing   notation for beta decay producing <math>
 <mrow>
  <msup>
   <mrow />
   <mrow>
  ...
  <mtext>B</mtext><mtext>a</mtext></mrow>
</math> . Refer to the periodic table for values of  . Refer to the periodic table for values of *Z*.
...
<equation id="fs-id1164568022601"> <math display="block">
 <mrow>
  <mmultiscripts>
   <mi>X</mi>
   <mprescripts />
...
<equation id="fs-id1164566345503"> <math display="block">
 <mrow>
  <mmultiscripts>
   <mtext>C</mtext>
   <mprescripts />
  ...
  <mo>+</mo><mi>e</mi><mo>+</mo><mi>v</mi></mrow>
</math>
</equation>
...
<equation id="fs-id1164567907098"> <math display="block">
 <mrow>
  <mmultiscripts>
   <mtext>C</mtext>
   <mprescripts />
...
Find the energy emitted in the  <math>
 <mi>α</mi>
</math>  decay of   decay of <sup>239</sup>Pu.

## Strategy
Nuclear reaction energy, such as released in  <math>
 <mi>α</mi>
</math>  decay, can be found using the equation    decay, can be found using the equation  <math>
 <mrow>
  <mi>E</mi><mo>=</mo><mi>m</mi><msup>
   <mi>c</mi>
   <mn>2</mn>
...
</math> . We must first find   . We must first find  <math>
 <mrow>
  <mtext>Δ</mtext><mi>m</mi></mrow>
</math>, the difference in mass between the parent nucleus and the products of the decay., the difference in mass between the parent nucleus and the products of the decay.
...
<equation id="fs-id1167067209015"><label /> <math>
 <mrow>
  <mmultiscripts>
   <mtext>P</mtext>
   <mprescripts />
  ...
  <mtext>u</mtext><mrow><mo>→</mo></mrow><mmultiscripts>
   <mtext>U</mtext>
   <mprescripts />
   <none />
   <mrow>
...
<equation id="fs-id1167063454307"><label /> <math>
 <mtable columnalign="left">
  <mtr>
   <mtd>
    <mtext>Δ</mtext><mi>m</mi><mo>=</mo><mi>m</mi><mrow><mo>(</mo>
     <mrow>
      <msup>
       <mrow />
       <mrow>
      ...
      <mtext>P</mtext><mspace width="0.25em" /><mtext>u</mtext></mrow>
     ...
     <mrow>
      <mi>m</mi><mrow><mo>(</mo>
       <mrow>
        ...
        <mtext>U</mtext></mrow>
      <mo>)</mo></mrow><mspace width="0.25em" /><mo>+</mo><mspace width="0.25em" /><mi>m</mi><mrow><mo>(</mo>
       <mrow>
        <msup>
         <mrow />
         <mn>4</mn>
        </msup>
        <mtext>H</mtext><mtext>e</mtext></mrow>
      <mo>)</mo></mrow></mrow>
    <mo>)</mo></mrow>
   </mtd>
  </mtr>
  <mtr>
   <mtd>
    <mtext>Δ</mtext><mi>m</mi><mo>=</mo><mn>239.052157</mn><mspace width="0.25em" /><mtext>u</mtext><mo>−</mo><mo stretchy="false">(</mo><mn>235.043924</mn><mspace width="0.25em" /><mtext>u</mtext><mo>+</mo><mn>4.002602</mn><mspace width="0.25em" /><mtext>u</mtext><mo stretchy="false">)</mo>
   </mtd>
  </mtr>
  <mtr>
   <mtd>
    <mtext>Δ</mtext><mi>m</mi><mo>=</mo><mn>0.0005631</mn><mspace width="0.25em" /><mtext>u</mtext>
   </mtd>
  </mtr>
 </mtable>
...
Now we can find *E *by entering  <math>
 <mrow>
  <mtext>Δ</mtext><mi>m</mi></mrow>
</math>  into the equation.  into the equation.

<equation id="fs-id1167063584155"><label /> <math>
 <mrow>
  ...
  <mo>=</mo><mrow><mo>(</mo>
   <mrow>
    <mn>0.005631</mn><mspace width="0.3em" /><mtext>u</mtext></mrow>
  <mo>)</mo></mrow><msup>
   <mi>c</mi>
   <mn>2</mn>
  </msup>
...
And knowing that  <math>
 <mrow>
  <mn>1</mn><mspace width="0.25em" /><mtext>u</mtext><mo>=</mo><mn>931.5</mn><mspace width="0.3em" /><mtext>m</mtext><mtext>e</mtext><mtext>V</mtext><mo>/</mo><msup>
   <mi>c</mi>
   <mn>2</mn>
  </msup>
  </mrow>
</math>, we can find that, we can find that

<equation id="fs-id1167066879020"><label /> <math>
 <mrow>
  <mi>E</mi><mo>=</mo><mrow><mo>(</mo>
   <mrow>
    <mn>0.005631</mn></mrow>
  <mo>)</mo></mrow><mrow><mo>(</mo>
   <mrow>
    <mn>931.5</mn><mspace width="0.25em" /><mtext>M</mtext><mtext>e</mtext><mtext>V</mtext><mo>/</mo><msup>
     <mi>c</mi>
     <mn>2</mn>
    </msup>
    </mrow>
  ...
  <mo>)</mo></mrow><mo>=</mo><mn>5.25</mn><mspace width="0.25em" /><mtext>M</mtext><mtext>e</mtext><mtext>V</mtext>
 <mtext>.</mtext>
 </mrow>
</math>
</equation>
## Discussion
The energy released in this  <math>
 <mi>α</mi>
</math>  decay is in the MeV range, about 10  decay is in the MeV range, about 10<sup>6</sup> times as great as typical chemical reaction energies, consistent with previous discussions. Most of the energy becomes kinetic energy of the  <math>
 <mi>α</mi>
</math>  particle (or   particle (or <sup>4</sup>He nucleus), which moves away at high speed.

The energy carried away by the recoil of the <sup>235</sup>U nucleus is much smaller, in order to conserve momentum. The <sup>235</sup>U nucleus can be left in an excited state to later emit photons ( <math>
 <mi>γ</mi>
</math>  rays). The decay is spontaneous and releases energy, because the products have less mass than the parent nucleus.  rays). The decay is spontaneous and releases energy, because the products have less mass than the parent nucleus.
...
* <math>
 <mrow>
  ...
  <mo>+</mo><mi>e</mi><mo>+</mo><mi>v</mi></mrow>
</math> . (Beta decay may also transform a proton into a neutron.)
* <math>
 <mrow>
  <mmultiscripts>
   <mi>X</mi>
