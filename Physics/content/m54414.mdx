...
<equation id="fs-id1167065768462"><label />
 <math>
 <mrow>
  <mi>F</mi><mo>∝</mo><mfrac>
   <mn>1</mn>
...
<equation id="fs-id1167065857450"><label />
 <math>
 <mrow>
  <mi>F</mi><mo>∝</mo><msub>
   <mi>q</mi>
...
</math>  is the charge on sphere A, and    is the charge on sphere A, and  <math>
 <mrow>
  <msub>
   <mi>q</mi>
   <mtext>B</mtext>
...
</math>  is the charge on sphere B.  is the charge on sphere B.
...
<equation id="fs-id1167066145647"><label />
 <math>
 <mrow>
  <mi>F</mi><mo>=</mo><mfrac>
   <mrow>
...
This equation is known as **Coulomb’s law**, and it describes the electrostatic force between charged objects. The constant of proportionality *k* is called ****. In SI units, the constant *k* has the value  <math>
 <mrow>
...
</math>  are negative or if both are positive, the force between them is repulsive. This is shown in   are negative or if both are positive, the force between them is repulsive. This is shown in [None](None)(a). If  <math>
 <mrow>
  <msub>
   <mi>q</mi>
   <mn>1</mn>
...
</math>  is a negative charge and    is a negative charge and  <math>
 <mrow>
  <msub>
   <mi>q</mi>
   <mn>2</mn>
...
</math>  is a positive charge (or vice versa), then the charges are different, so the force between them is attractive. This is shown in   is a positive charge (or vice versa), then the charges are different, so the force between them is attractive. This is shown in [None](None)(b).


<caption>The magnitude of the electrostatic force </caption>
Note that Coulomb’s law applies only to charged objects that are not moving with respect to each other. The law says that the force is proportional to the amount of charge on each object and inversely proportional to the square of the distance between the objects. If we double the charge  <math>
 <mrow>
  <msub>
   <mi>q</mi>
   <mn>1</mn>
...
</math>, for instance, then the force is doubled. If we double the distance between the objects, then the force between them , for instance, then the force is doubled. If we double the distance between the objects, then the force between them *decreases* by a factor of  <math>
 <mrow>
  <msup>
   <mn>2</mn>
   <mn>2</mn>
  ...
  <mo>=</mo><mn>4</mn></mrow>
</math> . Although Coulomb’s law is true in general, it is easiest to apply to spherical objects or to objects that are much smaller than the distance between the objects (in which case, the objects can be approximated as spheres). . Although Coulomb’s law is true in general, it is easiest to apply to spherical objects or to objects that are much smaller than the distance between the objects (in which case, the objects can be approximated as spheres).

Coulomb’s law is an example of an **inverse-square law**, which means the force depends on the square of the denominator. Another inverse-square law is Newton’s law of universal gravitation, which is  <math>
 <mrow>
  <mi>F</mi><mo>=</mo><mrow><mrow>
   <mi>G</mi><msub>
    <mi>m</mi>
    <mn>1</mn>
   </msub>
...
</math> . Although these laws are similar, they differ in two important respects: (i) The gravitational constant  . Although these laws are similar, they differ in two important respects: (i) The gravitational constant *G* is much, much smaller than *k* ( <math>
 <mrow>
...
Suppose Coulomb measures a force of  <math>
 <mrow>
  <mn>20</mn><mspace width="0.25em" /><mo>×</mo><mspace width="0.25em" /><msup>
   <mrow>
    <mn>10</mn></mrow>
   <mrow>
    <mn>−6</mn></mrow>
...
</math> . Because these charges appear as a product in Coulomb’s law, they form a single unknown. We thus have two equations and two unknowns, which we can solve. The first unknown is the force (which we call   . Because these charges appear as a product in Coulomb’s law, they form a single unknown. We thus have two equations and two unknowns, which we can solve. The first unknown is the force (which we call  <math>
 <mrow>
  <msub>
   <mi>F</mi>
   <mtext>f</mtext>
...
</math> ) when the spheres are 3.0 cm apart, and the second is   ) when the spheres are 3.0 cm apart, and the second is  <math>
 <mrow>
  <msub>
   <mi>q</mi>
   <mn>1</mn>
...
Use the following notation: When the charges are 5.0 cm apart, the force is  <math>
 <mrow>
  <msub>
   <mi>F</mi>
   <mtext>i</mtext>
  </msub>
  <mo>=</mo><mn>20</mn><mspace width="0.25em" /><mo>×</mo><mspace width="0.25em" /><msup>
   <mrow>
    <mn>10</mn></mrow>
   <mrow>
    <mn>−6</mn></mrow>
 ...
 <mrow>
  ...
  <mo>=</mo><mn>5.0</mn><mspace width="0.3em" /><mtext>cm</mtext><mo>=</mo><mn>0.050</mn><mspace width="0.3em" /><mtext>m</mtext></mrow>
</math>, where the subscript , where the subscript *i* means *initial*. Once the charges are brought closer together, we know  <math>
 <mrow>
  <msub>
   <mi>r</mi>
   <mtext>f</mtext>
  </msub>
  <mo>=</mo><mn>3.0</mn><mspace width="0.3em" /><mtext>cm</mtext><mo>=</mo><mn>0.030</mn><mspace width="0.3em" /><mtext>m</mtext></mrow>
</math>, where the subscript , where the subscript *f* means *final*.

## Solution
Coulomb’s law applied to the spheres in their initial positions gives

<equation id="fs-id1164564389075"> <math display="block">
 <mrow>
  <msub>
   <mi>F</mi>
   <mtext>i</mtext>
...
<equation id="fs-id1164567529676"> <math display="block">
 <mrow>
  <msub>
   <mi>F</mi>
   <mtext>f</mtext>
...
Dividing the second equation by the first and solving for the final force  <math>
 <mrow>
  <msub>
   <mi>F</mi>
   <mtext>f</mtext>
...
</math>  leads to  leads to

<equation id="fs-id1164567638866"> <math display="block">
 <mrow>
  <mtable>
   <mtr>
...
<equation id="fs-id1164565546700"> <math display="block">
 <mrow>
  <mtable>
   <mtr>
    <mtd>
       ...
       <mrow>
        <msup>
         <mrow>
          <mrow><mo>(</mo>
           <mrow>
            <mn>0.050</mn><mspace width="0.3em" /><mtext>m</mtext></mrow>
          <mo>)</mo></mrow></mrow>
         <mn>2</mn>
        </msup>
        </mrow>
       <mrow>
        <msup>
         <mrow>
          <mrow><mo>(</mo>
           <mrow>
            <mn>0.030</mn><mspace width="0.3em" /><mtext>m</mtext></mrow>
          <mo>)</mo></mrow></mrow>
         <mn>2</mn>
        </msup>
        </mrow>
   ...
   <mtr rowalign="center">
    ...
    <mtd columnalign="left">
     <mrow>
      <mn>56</mn><mspace width="0.25em" /><mo>×</mo><mspace width="0.25em" /><msup>
       <mrow>
        <mn>10</mn></mrow>
       <mrow>
        <mn>−6</mn></mrow>
   ...
   <mtr rowalign="center">
    ...
    <mtd columnalign="left">
     <mrow>
      <mn>5.6</mn><mspace width="0.25em" /><mo>×</mo><mspace width="0.25em" /><msup>
       <mrow>
        <mn>10</mn></mrow>
       <mrow>
        <mn>−5</mn></mrow>
...
We can also solve for the second unknown  <math>
 <mrow>
  <mrow><mo>|</mo> <mrow>
   <msub>
    <mi>q</mi>
...
</math> . By using the first equation, we find . By using the first equation, we find

<equation id="fs-id1164567165922"> <math display="block">
 <mrow>
  <mtable>
   <mtr>
    <mtd columnalign="right">
...
<equation id="fs-id1164567459850"> <math display="block">
 <mrow>
  <msub>
   <mi>q</mi>
   <mn>1</mn>
  ...
  <mo>=</mo><mo>±</mo><mn>2.4</mn><mspace width="0.3em" /><mtext>nC.</mtext></mrow>
</math> </equation>
## Using Coulomb’s law to find the distance between charged objects
An engineer measures the force between two ink drops by measuring their acceleration and their diameter. She finds that each member of a pair of ink drops exerts a repulsive force of  <math>
 <mrow>
  <mi>F</mi><mo>=</mo><mn>5.5</mn><mspace width="0.3em" /><mtext>mN</mtext></mrow>
</math>  on its partner. If each ink drop carries a charge    on its partner. If each ink drop carries a charge  <math>
 <mrow>
  <msub>
   <mi>q</mi>
   <mrow>
  ...
  <mtext>C</mtext></mrow>
</math>, how far apart are the ink drops?, how far apart are the ink drops?

## Strategy
We know the force and the charge on each ink drop, so we can solve Coulomb’s law for the distance *r* between the ink drops. Do not forget to convert the force into SI units:  <math>
 <mrow>
  <mi>F</mi><mo>=</mo><mn>5.5</mn><mspace width="0.3em" /><mtext>mN</mtext><mo>=</mo><mn>5.5</mn><mspace width="0.25em" /><mo>×</mo><mspace width="0.25em" /><msup>
   <mrow>
    <mn>10</mn></mrow>
   <mrow>
    <mn>−3</mn></mrow>
...
## Solution
The charges in Coulomb’s law are  <math>
 <mrow>
  <msub>
   <mi>q</mi>
   <mn>1</mn>
...
</math>  so the numerator in Coulomb’s law takes the form    so the numerator in Coulomb’s law takes the form  <math>
 <mrow>
  <msub>
   <mi>q</mi>
   <mn>1</mn>
...
</math> . Inserting this into Coulomb’s law and solving for the distance  . Inserting this into Coulomb’s law and solving for the distance *r* gives

<equation id="fs-id1164564348094"> <math display="block">
 <mrow>
  <mtable>
   <mtr>
    <mtd columnalign="right">
         ...
         <mrow>
          ...
          <mo>)</mo></mrow><msup>
           <mrow>
            <mrow><mo>(</mo>
             <mrow>
              <mn>−1</mn><mspace width="0.25em" /><mo>×</mo><mspace width="0.25em" /><msup>
               <mrow>
                <mn>10</mn></mrow>
               <mrow>
                <mn>−10</mn></mrow>
