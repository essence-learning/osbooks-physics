...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_09_03_levers.jpg)<caption>(a) A pry bar is a type of lever. (b) The ideal mechanical advantage equals the length of the effort arm divided by the length of the resistance arm of a lever.</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_09_03_wheel.jpg)<caption>Force applied to a wheel exerts a force on its axle.</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_09_03_wedge.jpg)<caption>An inclined plane is shown on the left, and a wedge is shown on the right.</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_09_03_screw.jpg)<caption>The screw shown here is used to lift very heavy objects, like the corner of a car or a house a short distance.</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_09_03_pulleys.jpg)<caption>Three pulley systems are shown here.</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_09_03_wirecutter.jpg)<caption>Wire cutters are a common complex machine.</caption>
