...
The equation for the change in entropy,  <math>
 <mrow>
  <mi>Δ</mi><mi>S</mi>
 </mrow>
</math>, is, is

<equation id="fs-id1167065688021" class="unnumbered">
<label />
 <math>
 <mrow>
  <mi>Δ</mi><mi>S</mi><mo>=</mo><mfrac>
   <mi>Q</mi>
   <mi>T</mi>
  </mfrac>
  <mo>,</mo><mtext> </mtext>
...
</math>  at lower temperatures (smaller   at lower temperatures (smaller *T*). The decrease in entropy of the hot (larger *T*) object is therefore less than the increase in entropy of the cold (smaller *T*) object, producing an overall increase in entropy for the system.
...
Suppose we mix equal masses of water that are originally at two different temperatures, say  <math>
 <mrow>
  <mtext>20</mtext><mtext>.0 °C</mtext>
 </mrow>
</math> 
 and   
 and  <math>
 <mrow>
  <mtext>40</mtext><mtext>.0 °C</mtext>
 </mrow>
</math> . The result will be water at an intermediate temperature of   . The result will be water at an intermediate temperature of  <math>
 <mrow>
  <mtext>30</mtext><mtext>.0 °C</mtext>
 </mrow>
...
Based on this equation, we see that  <math>
 <mrow>
  <mi>Δ</mi><msub>
   <mi>S</mi>
   <mrow>
...
</math>  can be negative as long as    can be negative as long as  <math>
 <mrow>
  <mi>Δ</mi><msub>
   <mi>S</mi>
   <mrow>
...
</math>  is positive and greater in magnitude.  is positive and greater in magnitude.

How is it possible for the entropy of a system to decrease? Energy transfer is necessary. If you pick up marbles that are scattered about the room and put them into a cup, your work has decreased the entropy of that system. If you gather iron ore from the ground and convert it into steel and build a bridge, your work has decreased the entropy of that system. Energy coming from the sun can decrease the entropy of local systems on Earth—that is,  <math>
 <mrow>
  <mi>Δ</mi><msub>
   <mi>S</mi>
   <mrow>
...
</math>  is negative. But the overall entropy of the rest of the universe increases by a greater amount—that is,    is negative. But the overall entropy of the rest of the universe increases by a greater amount—that is,  <math>
 <mrow>
  <mi>Δ</mi><msub>
   <mi>S</mi>
   <mrow>
...
Find the increase in entropy of 1.00 kg of ice that is originally at  <math>
 <mrow>
  <mtext>0 °C</mtext>
 </mrow>
</math> 
 and melts to form water at   
 and melts to form water at  <math>
 <mrow>
  <mtext>0 °C</mtext>
 </mrow>
</math> . .
...
## Strategy
The change in entropy can be calculated from the definition of  <math>
 <mrow>
  <mi>Δ</mi><mi>S</mi>
 </mrow>
</math>  once we find the energy,   once we find the energy, *Q*, needed to melt the ice.

## Solution
The change in entropy is defined as

<equation id="fs-id1164566522678"> <math display="block">
 <mrow>
  <mi>Δ</mi><mi>S</mi><mo>=</mo><mfrac>
   <mi>Q</mi>
   <mi>T</mi>
...
<equation id="fs-id1164560820986"> <math display="block">
 <mrow>
...
</math>  is the latent heat of fusion.    is the latent heat of fusion.  <math>
 <mrow>
  <msub>
   <mi>L</mi>
   <mi>f</mi>
  </msub>
  <mo>=</mo><mtext>334 kJ/kg</mtext>
 </mrow>
</math>  for water, so  for water, so

<equation id="fs-id1164565282798"> <math display="block">
 <mrow>
  <mi>Q</mi><mo>=</mo><mo stretchy="false">(</mo><mtext>1</mtext><mtext>.00 kg</mtext><mo stretchy="false">)</mo><mo stretchy="false">(</mo><mtext>334 kJ/kg</mtext><mo stretchy="false">)</mo><mo>=</mo><mn>3.34</mn><mo>×</mo><msup>
   <mrow>
    <mn>10</mn>
   </mrow>
   <mn>5</mn>
...
Because *Q* is the amount of energy heat adds to the ice, its value is positive, and *T *is the melting temperature of ice,  <math>
 <mrow>
  <mi>T</mi><mo>=</mo><mtext>273 K</mtext>
 </mrow>
</math>  So the change in entropy is  So the change in entropy is

<equation id="fs-id1164563431889"> <math display="block">
 <mrow>
  <mi>Δ</mi><mi>S</mi><mo>=</mo><mfrac>
   <mi>Q</mi>
   <mi>T</mi>
