...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_10_02_astronaut.jpg)<caption>(a) An astronaut measures the time </caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_10_02_road.jpg)<caption>People might describe distances differently, but at relativistic speeds, the distances really are different. (Corey Leopold, Flickr)
</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_10_02_speed.jpg)<caption>Relativistic momentum approaches infinity as the velocity of an object approaches the speed of light.</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_10_02_energy.jpg)<caption>The sun (a) and the Susquehanna Steam Electric Station (b) both convert mass into energy. ((a) NASA/Goddard Space Flight Center, Scientific Visualization Studio; (b) U.S. government)</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_10_02_lab.jpg)<caption>Brookhaven National Laboratory. The circular structure houses the RHIC. (energy.gov, Wikimedia Commons)</caption>
