...
The **antinode** is the location of maximum amplitude in standing waves. The standing waves on a string have a frequency that is related to the propagation speed  vw  of the disturbance on the string. The wavelength  λ  is determined by the distance between the points where the string is fixed in place.
