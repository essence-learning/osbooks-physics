...
<table>
  <tr>
    ...
    <td>destructive interference</td>
    <td>inversion</td>
    <td>nodes</td>
  </tr>
  <tr>
...
The **antinode** is the location of maximum amplitude in standing waves. The standing waves on a string have a frequency that is related to the propagation speed  <math>
 <mrow>
  <msub>
   <mi>v</mi>
   <mi>w</mi>
...
</math>  of the disturbance on the string. The wavelength    of the disturbance on the string. The wavelength  <math>
 <mi>λ</mi>
</math>  is determined by the distance between the points where the string is fixed in place.  is determined by the distance between the points where the string is fixed in place.
