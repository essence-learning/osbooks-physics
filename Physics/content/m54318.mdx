...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_13_03_Superposit.jpg)<caption>These waves result from the superposition of several waves from different sources, producing a complex pattern. (Waterborough, Wikimedia Commons)</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_13_03_Construct.jpg)<caption>The pure constructive interference of two identical waves produces a wave with twice the amplitude but the same wavelength.</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_13_03_Destruct.jpg)<caption>The pure destructive interference of two identical waves produces zero amplitude, or complete cancellation.</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_13_03_Dissimilar.jpg)<caption>The superposition of nonidentical waves exhibits both constructive and destructive interferences.</caption>
## Wave Interference
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_13_03_Standing.jpg)<caption>A standing wave is created by the superposition of two identical waves moving in opposite directions. The oscillations are at fixed locations in space and result from alternating constructive and destructive interferences.</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_13_03_Antinode.jpg)<caption>The figure shows a string oscillating with its maximum disturbance as the antinode.</caption>
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_13_03_Antinodes.jpg)<caption>The figure shows a string oscillating with multiple nodes.</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_13_03_Inversion.jpg)<caption>A wave is inverted after reflection from a fixed end.</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_13_03_Refraction.jpg)<caption>A wave refracts as it enters a different medium.</caption>
