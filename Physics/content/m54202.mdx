...
<equation id="eip-167" class="unnumbered"><label />
 <math>
<mrow>
<mtext>Δ</mtext><msub>
...
where *F*1 is the force on car 1 due to car 2, and  <math>
<mrow>
<mtext>Δ</mtext><mi>t</mi>
</mrow>
</math>  is the time the force acts, or the duration of the collision.  is the time the force acts, or the duration of the collision.

Similarly, the change in momentum of car 2 is  <math>
<mrow>
<mtext>Δ</mtext><msub>
<mstyle mathvariant="bold" mathsize="normal"><mi>p</mi></mstyle>
<mn>2</mn>
...
</math>  where   where *F*2 is the force on car 2 due to car 1, and we assume the duration of the collision  <math>
<mrow>
<mtext>Δ</mtext><mi>t</mi>
</mrow>
</math>  is the same for both cars. We know from Newton’s third law of motion that   is the same for both cars. We know from Newton’s third law of motion that *F*2 = –*F*1, and so  <math>
<mrow>
<mtext>Δ</mtext><msub>
<mstyle mathvariant="bold" mathsize="normal"><mi>p</mi></mstyle>
<mn>2</mn>
...
<mtext>Δ</mtext><mi>t</mi><mo>=</mo><mo>−</mo><mtext>Δ</mtext><msub>
<mstyle mathvariant="bold" mathsize="normal"><mi>p</mi></mstyle>
<mn>1</mn>
</msub>
...
Therefore, the changes in momentum are equal and opposite, and  <math>
<mrow>
<mtext>Δ</mtext><msub>
<mstyle mathvariant="bold" mathsize="normal"><mi>p</mi></mstyle>
<mn>1</mn>
</msub>
<mo>+</mo><mtext>Δ</mtext><msub>
<mstyle mathvariant="bold" mathsize="normal"><mi>p</mi></mstyle>
<mn>2</mn>
</msub>
<mo>=</mo><mn>0</mn>
...
<equation id="fs-id1167066874701" class="unnumbered"><label />
 <math>
<mrow>
<msub>
<mstyle mathvariant="bold" mathsize="normal"><mtext>p</mtext></mstyle>
<mn>1</mn>
</msub>
<mo>+</mo><msub>
<mstyle mathvariant="bold" mathsize="normal"><mtext>p</mtext></mstyle>
...
<mo>=</mo><mtext>constant</mtext>
</mrow>
</math> 
</equation>


<equation id="fs-id1167067066930" class="unnumbered"><label />
 <math>
<mrow>
<msub>
<mstyle mathvariant="bold" mathsize="normal"><mi>p</mi></mstyle>
...
<equation id="fs-id1167067038344" class="unnumbered"><label />
 <math>
<mrow>
<msub>
<mstyle mathvariant="bold" mathsize="normal"><mtext>p</mtext></mstyle>
...
<equation id="fs-id1167066971379" class="unnumbered"><label />
 <math>
<mrow>
<msub>
<mstyle mathvariant="bold" mathsize="normal"><mi>p</mi></mstyle>
...
We already know the equation for linear momentum, *p* = *m**v*. Since angular momentum is analogous to linear momentum, the moment of inertia (*I*) is analogous to mass, and angular velocity  <math>
 
  <mrow>
   <mo stretchy="false">(</mo><mstyle mathvariant="bold" mathsize="normal"><mtext>ω</mtext></mstyle><mo stretchy="false">)</mo>
  </mrow>
 
</math>  is analogous to linear velocity, it makes sense that angular momentum (  is analogous to linear velocity, it makes sense that angular momentum (*L*) is defined as 

<equation id="fs-id1167067058676" class="unnumbered"><label />
 <math>
<mrow>
<mstyle mathvariant="bold" mathsize="normal"><mi>L</mi></mstyle><mo>=</mo><mi>I</mi><mstyle mathvariant="bold" mathsize="normal"><mtext>ω</mtext></mstyle>
</mrow>
</math> 
</equation>

Angular momentum is conserved when the net external torque ( <math>
<mstyle mathvariant="bold" mathsize="normal"><mi>τ</mi></mstyle>
</math> ) is zero, just as linear momentum is conserved when the net external force is zero. ) is zero, just as linear momentum is conserved when the net external force is zero.

Figure skaters take advantage of the conservation of angular momentum, likely without even realizing it. In [None](None), a figure skater is executing a spin. The net torque on her is very close to zero, because there is relatively little friction between her skates and the ice, and because the friction is exerted very close to the pivot point. Both *F* and *r *are small, and so  <math>
<mrow>
<mstyle mathvariant="bold" mathsize="normal"><mi>τ</mi></mstyle>
</mrow>
</math>  is negligibly small.  is negligibly small.
...
<equation id="fs-id1167067044452" class="unnumbered"><label />
 <math>
<mrow>
  <mi>I</mi><mstyle mathvariant="bold" mathsize="normal"><mi>ω</mi></mstyle><mo>=</mo><msup>
    <mi>I</mi>
    <mo>′</mo>
  </msup>
  <mstyle mathvariant="bold" mathsize="normal"><msup>
...
where the primed quantities refer to conditions after she has pulled in her arms and reduced her moment of inertia. Because *I*′ is smaller, the angular velocity  <math>
<mstyle mathvariant="bold" mathsize="normal"><msup>
<mi>ω</mi>
<mo>′</mo>
</msup>
</mstyle>
</math>  must increase to keep the angular momentum constant. This allows her to spin much faster without exerting any extra torque.  must increase to keep the angular momentum constant. This allows her to spin much faster without exerting any extra torque.
