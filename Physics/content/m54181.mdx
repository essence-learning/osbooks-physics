...
<equation id="fs-id1167065858756" class="unnumbered"><label />
 <math>
 <mrow>
  <msub>
    <mi>a</mi>
...
We can also express *a*c in terms of the magnitude of **angular velocity**. Substituting  <math>
 <mrow>
  <mi>v</mi><mo>=</mo><mi>r</mi><mi>ω</mi></mrow>
</math>  into the equation above, we get    into the equation above, we get  <math>
  ...
  <mrow>
   ...
   <mo>=</mo><mfrac>
    <mrow>
     <msup>
      <mrow>
       <mo stretchy="false">(</mo><mi>r</mi><mi>ω</mi><mo stretchy="false">)</mo>
      </mrow>
      <mn>2</mn>
     </msup>
...
</math> . Therefore, the magnitude of centripetal acceleration in terms of the magnitude of angular velocity is  . Therefore, the magnitude of centripetal acceleration in terms of the magnitude of angular velocity is <equation id="fs-id1167065820320"> <math>
...
By using the two different forms of the equation for the magnitude of centripetal acceleration,  <math>
 <mrow>
  <msub>
   <mi>a</mi>
   <mtext>c</mtext>
...
<equation id="fs-id1167064850065" class="unnumbered"><label />
 <math>
 <mrow>
  <mi>r</mi><mo>=</mo><mfrac>
   <mrow>
...
> In this activity, you will measure the swing of a golf club or tennis racket to estimate the centripetal acceleration of the end of the club or racket. You may choose to do this in slow motion. Recall that the equation for centripetal acceleration is  <math>
>  <mrow>
>   <msub>
>    <mstyle mathvariant="bold" mathsize="normal"><mi>a</mi></mstyle>
>    <mtext>c</mtext>
...
## Strategy
Because linear rather than angular speed is given, it is most convenient to use the expression  <math>
 <mrow>
  <msub>
   <mstyle mathvariant="bold" mathsize="normal"><mi>a</mi></mstyle>
   <mtext>c</mtext>
...
</math>  to find the magnitude of the centripetal acceleration.  to find the magnitude of the centripetal acceleration.

## Solution
Entering the given values of *v *= 25.0 m/s and *r *= 500 m into the expression for *a*c gives

<equation id="fs-id1167064907892" class="unnumbered"><label />
 <math>
 <mrow>
  <mtable>
   <mtr rowalign="center">
       ...
       <mrow>
        <msup>
         <mrow>
          <mrow><mo>(</mo>
           <mrow>
            <mn>25.0</mn><mspace width="0.3em" /><mtext>m/s</mtext></mrow>
          <mo>)</mo></mrow></mrow>
         <mn>2</mn>
        </msup>
        </mrow>
       <mrow>
        <mn>500</mn><mspace width="0.3em" /><mtext>m</mtext></mrow>
      </mfrac>
      </mrow>
    </mtd>
   </mtr>
...
## Discussion
To compare this with the acceleration due to gravity (*g *= 9.80 m/s<sup>2</sup>), we take the ratio  <math>
 <mrow>
  <mrow><mrow>
   <msub>
    <mstyle mathvariant="bold" mathsize="normal"><mi>a</mi></mstyle>
  ...
  <mo>=</mo><mrow><mrow>
   <mo stretchy="false">(</mo><mn>1.25</mn><msup>
    <mrow>
     <mtext> m/s</mtext></mrow>
    <mtext>2</mtext>
   </msup>
   ...
   <mo stretchy="false">)</mo></mrow></mrow>
  <mo>=</mo><mn>0.128</mn></mrow>
 ...
 <mrow>
  ...
  <mo>=</mo><mn>0.128</mn><mi>g</mi></mrow>
</math>, which means that the centripetal acceleration is about one tenth the acceleration due to gravity., which means that the centripetal acceleration is about one tenth the acceleration due to gravity.
...
</math> . Therefore, . Therefore,

<equation id="fs-id1167066145476" class="unnumbered"><label />
 <math>
 <mrow>
  <mtable>
   <mtr rowalign="center">
     ...
     <mrow>
      <mfrac>
       <mrow>
        <mrow><mo>(</mo>
         <mrow>
          <mn>900</mn><mspace width="0.3em" /><mtext>kg</mtext></mrow>
        <mo>)</mo></mrow><msup>
         <mrow>
          <mrow><mo>(</mo>
           <mrow>
       ...
       <mrow>
        <mn>600</mn><mspace width="0.3em" /><mtext>m</mtext></mrow>
      </mfrac>
      </mrow>
    </mtd>
   </mtr>
   <mtr rowalign="center">
    ...
    <mtd rowalign="center" columnalign="left">
     <mrow>
      <mn>938</mn><mspace width="0.3em" /><mtext>N.</mtext></mrow>
    </mtd>
   </mtr>
...
<equation id="fs-id1167064910740" class="unnumbered"><label />
 <math>
 <mrow>
  <mi>f</mi><mo>=</mo><msub>
   <mstyle mathvariant="bold" mathsize="normal"><mi>F</mi></mstyle>
  ...
  <mo>=</mo><mn>938</mn><mspace width="0.3em" /><mtext>N</mtext></mrow>
</math>
</equation>
...
<math><mrow>
<mi>f</mi>
<mo>=</mo><msub><mi>μ</mi><mi>s</mi></msub><mtext>N</mtext>
<mo>=</mo><msub><mi>μ</mi><mi>s</mi></msub><mi>m</mi><mi>g</mi>
</mrow></math>. Solving for . Solving for <math><mrow><msub><mi>μ</mi><mi>s</mi></msub></mrow></math>, we get
, we get
<math>
  <mrow>
    ...
    <mo>=</mo><mfrac>
      <mrow><mn>938</mn></mrow>
      <mrow><mn>900</mn><mspace width="0.2em" /><mo>×</mo><mspace width="0.2em" /><mn>9.8</mn></mrow>
    </mfrac>
    <mo>=</mo><mn>0.11</mn>
  </mrow>
</math>. Regardless of whether we know the maximum allowable speed for rounding the curve, we can conclude this is a minimum value for the coefficient.. Regardless of whether we know the maximum allowable speed for rounding the curve, we can conclude this is a minimum value for the coefficient.

## Discussion
Since we found the force of friction in part (b), we could also solve for the coefficient of friction, since  <math>
 <mrow>
  <mi>f</mi><mo>=</mo><msub>
   <mi>μ</mi>
   <mtext>s</mtext>
  </msub>
  <mtext>N</mtext><mo>=</mo><msub>
   <mi>μ</mi>
   <mtext>s</mtext>
  </msub>
  <mi>m</mi><mi>g</mi></mrow>
</math>. The static friction is only equal to 
. The static friction is only equal to 
<math><mrow><msub><mi>μ</mi><mi>s</mi></msub>
 <mtext>N</mtext></mrow></math> when it is at the maximum possible value. If the car could go faster, the friction at the given speed would still be the same as we calculated, but the coefficient of static friction would be larger. when it is at the maximum possible value. If the car could go faster, the friction at the given speed would still be the same as we calculated, but the coefficient of static friction would be larger.
