...
f=3.00×108 m/s6.00×10−7 m=5.00×1014 s−1=5.00×1014 Hz## Discussion
...
illuminance =P4πr2.What happens if the radius of the sphere is increased 2 m? The illuminance is now only one-fourth as great, because the *r*<sup>2</sup> term in the denominator is 4 instead of 1. [None](None) shows how illuminance decreases with the inverse square of the distance.
...
1. Illuminance = P 4πr2;
2. Illuminance = P 4πr;
3. Illuminance = P · 4πr2;
4. Illuminance = P · 4πr;
