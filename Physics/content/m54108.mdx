...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_02_01_airplane.jpg)<caption>Are clouds a useful reference frame for airplane passengers? Why or why not? (Paul Brennan, Public Domain)</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_02_01_Galileo.jpg)<caption>Galileo Galilei (1564–1642) studied motion and developed the concept of a reference frame. (Domenico Tintoretto)
</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_02_01_house.jpg)<caption>Your total change in position is measured from your house to your school.</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_02_01_comic.jpg)<caption>A short line separates the starting and ending points of this motion, but the distance along the path of motion is considerably longer.</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_02_01_arrow.jpg)<caption>The total distance that your car travels is 10 km, but the total displacement is 0.</caption>
> ## Distance vs. Displacement
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_02_01_Mars.jpg)<caption>The Mars Climate Orbiter disaster illustrates the importance of using the correct calculations in physics. (NASA)</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_02_01_displace_img.jpg)<caption>None</caption>
