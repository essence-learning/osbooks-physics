...
<equation id="fs-id1164565014922"> <math display="block">
 <mrow>
  <mi>c</mi><mo>=</mo><mn>2.9972458</mn><mspace width="0.25em" /><mo>×</mo><mspace width="0.25em" /><msup>
   <mrow>
    <mn>10</mn></mrow>
   <mn>8</mn>
  </msup>
  <mtext>m/s</mtext><mo>≈</mo><mn>3.00</mn><mspace width="0.25em" /><mo>×</mo><mspace width="0.25em" /><msup>
   <mrow>
    <mn>10</mn></mrow>
   <mn>8</mn>
  </msup>
...
<equation id="fs-id1164566493092"> <math display="block">
 <mrow>
  <mfrac>
   <mrow>
    <mi>sin</mi><msub>
...
</math> . Now, imagine what happens as the incident angle is increased. This causes   . Now, imagine what happens as the incident angle is increased. This causes  <math>
 <mrow>
  <msub>
   <mi>θ</mi>
   <mtext>2</mtext>
...
</math>  to increase as well. The largest the angle of refraction,    to increase as well. The largest the angle of refraction,  <math>
 <mrow>
  <msub>
   <mi>θ</mi>
   <mtext>2</mtext>
...
</math>, can be is 90°, as shown in , can be is 90°, as shown in [None](None)(b). The **critical angle**,  <math>
 <mrow>
  <msub>
   <mi>θ</mi>
   <mtext>c</mtext>
...
</math>, for a combination of two materials is defined to be the incident angle,  , for a combination of two materials is defined to be the incident angle,  <math>
 <mrow>
  <msub>
   <mi>θ</mi>
   <mtext>1</mtext>
...
</math>, which produces an angle of refraction of 90°. That is,  , which produces an angle of refraction of 90°. That is,  <math>
 <mrow>
  <msub>
   <mi>θ</mi>
   <mtext>c</mtext>
...
</math>  is the incident angle for which    is the incident angle for which  <math>
 <mrow>
  <msub>
   <mi>θ</mi>
   <mtext>2</mtext>
...
</math>  *= *90°. If the incident angle,  <math>
 <mrow>
  <msub>
   <mi>θ</mi>
   <mtext>1</mtext>
...
</math>, is greater than the critical angle, as shown in , is greater than the critical angle, as shown in [None](None)(c), then all the light is reflected back into medium 1, a condition called ****.
...
<equation id="fs-id1164563204282"> <math display="block">
 <mrow>
  <msub>
   <mi>n</mi>
   <mn>1</mn>
...
When the incident angle equals the critical angle ( <math>
 <mrow>
  <msub>
   <mi>θ</mi>
   <mtext>1</mtext>
...
), the angle of refraction is 90° ( <math>
 <mrow>
  <msub>
   <mi>θ</mi>
   <mtext>2</mtext>
...
<equation id="fs-id1167065677119" class="unnumbered">
<label />
 <math display="block">
 <mrow>
  <msub>
...
</math>, for a given combination of materials is thus, for a given combination of materials is thus
...
Total internal reflection occurs for any incident angle greater than the critical angle,  <math>
 <mrow>
  <msub>
   <mi>θ</mi>
   <mtext>c</mtext>
...
</math>, and it can only occur when the second medium has an index of refraction less than the first. Note that the previous equation is written for a light ray that travels in medium 1 and reflects from medium 2, as shown in , and it can only occur when the second medium has an index of refraction less than the first. Note that the previous equation is written for a light ray that travels in medium 1 and reflects from medium 2, as shown in [None](None).
...
<equation id="fs-id1167064746452" class="unnumberes">
<label />
 <math display="block">
 <mrow>
  <mi>n</mi><mo>=</mo><mfrac>
...
<label />
 ...
 <mrow>
  ...
  <mo>)</mo></mrow><mtext>, for </mtext><msub>
   <mi>n</mi>
   <mn>1</mn>
  </msub>
  <mo>&gt;</mo><msub>
...
Calculate the index of refraction for a solid medium in which the speed of light is 2.012  <math>
 <mo>×</mo>
</math>  10  10<sup>8</sup> m/s, and identify the most likely substance, based on the  previous table of indicies of refraction.

## Strategy
We know the speed of light, *c*, is 3.00  <math>
 <mo>×</mo>
</math>  10  10<sup>8</sup> m/s, and we are given *v*. We can simply plug these values into the equation for index of refraction, *n*. 

## Solution
<equation id="fs-id1164565195530"> <math display="block">
 <mrow>
  <mi>n</mi><mo>=</mo><mfrac>
   <mi>c</mi>
   <mi>v</mi>
  ...
  <mo>=</mo><mfrac>
   <mrow>
    ...
    <mtext>m/s</mtext></mrow>
   <mrow>
    <mn>2.012</mn><mspace width="0.25em" /><mo>×</mo><mspace width="0.25em" /><msup>
     <mrow>
      <mn>10</mn></mrow>
     <mn>8</mn>
    </msup>
...
<equation id="fs-id1164564829480"> <math display="block">
 <mrow>
  <mfrac>
   <mrow>
    <msub>
...
<equation id="fs-id1164566941978"> <math display="block">
 <mrow>
  <msub>
   <mi>n</mi>
   <mn>2</mn>
...
## Solution
<equation id="fs-id1164564910076"> <math display="block">
 <mrow>
  <msub>
   <mi>n</mi>
   <mn>2</mn>
  ...
  <mo>=</mo><mfrac>
   <mrow>
    <mo stretchy="false">(</mo><mn>1.333</mn><mo stretchy="false">)</mo><mo stretchy="false">(</mo><mn>0.7071</mn><mo stretchy="false">)</mo></mrow>
   <mrow>
    <mn>0.6468</mn></mrow>
  </mfrac>
  <mo>=</mo><mn>1.457</mn></mrow>
</math>
</equation>
...
## Discussion
Note the relative sizes of the variables involved. For example, a larger angle has a larger sine value. This checks out for the two angles involved. Note that the smaller value of  <math>
 <mrow>
  <msub>
   <mi>θ</mi>
   <mtext>2</mtext>
...
</math>  compared with    compared with  <math>
 <mrow>
  <msub>
   <mi>θ</mi>
   <mtext>1</mtext>
...
</math>  indicates the ray has bent   indicates the ray has bent *toward* normal. This result is to be expected if the unknown substance has a greater *n* value than that of water. The result shows that this is the case.
...
<equation id="fs-id1164563564864">
 <math display="block">
 <mrow>
  <msub>
   <mi>θ</mi>
...
Then, look up the *n* values for water, *n*1, and air, *n*2. Find the value of
 <math><mfrac>
    ...
    </mfrac></math> . Last, find the angle that has a sine equal to this value and it compare with the given angle of 48.6°. . Last, find the angle that has a sine equal to this value and it compare with the given angle of 48.6°.

## Solution
For water, *n*1 = 1.333; for air, *n*2 = 1.0003. So,

<equation id="fs-id1164562164023"> <math display="block">
 <mtable columnalign="left">
  ...
  <mtr>
   <mtd>
    ...
    <mo stretchy="false">(</mo><mn>0.7504</mn><mo stretchy="false">)</mo><mo>=</mo><mn>48.63°</mn><mo /><mo>.</mo>
   </mtd>
  </mtr>
 </mtable>
...
</math>, determines whether total internal refraction can take place, and can be calculated according to  <math>
 <mrow>
  <msub>
   <mi>θ</mi>
   <mi>c</mi>
  </msub>
  <mo>=</mo><mtext> </mtext><mi>s</mi><mi>i</mi><msup>
   <mi>n</mi>
   <mrow>
    <mo>−</mo><mn>1</mn></mrow>
  </msup>
  <mo stretchy="false">(</mo><mfrac><mrow><msub>
   <mi>n</mi>
   <mn>2</mn>
  </msub></mrow>
  <mrow><msub>
...
<table>
  <tr>
    <td>index of Refraction</td>
    <td><math><mi>n</mi><mo>=</mo><mfrac><mi>c</mi><mi>v</mi></mfrac></math></td>
  </tr>
  <tr>
    <td>Snell’s law</td>
    <td><math>
