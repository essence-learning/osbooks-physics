...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_01_01_gold.jpg)<caption>Using a scanning tunneling microscope (STM), scientists can see the individual atoms that compose this sheet of gold. (Erwinrossen)</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_01_01_collider.jpg)<caption>Particle colliders such as the Large Hadron Collider in Switzerland or Fermilab in the United States (pictured here), have long tunnels that allows subatomic particles to be accelerated to near light speed. (Andrius.v )</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_01_01_microwave.jpg)<caption>Why can't you put metal in the microwave? Microwaves are high-energy radiation that increases the movement of electrons in metal. These moving electrons can create an electrical current, causing sparking that can lead to a fire. (= MoneyBlogNewz)</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_01_01_eye.jpg)<caption>Magnetic resonance imaging (MRI) uses electromagnetic waves to yield an image of the brain, which doctors can use to find diseased regions. (Rashmi Chawla, Daniel Smith, and Paul E. Marik)</caption>
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_01_01_cell.jpg)<caption>Physics, chemistry, and biology help describe the properties of cell walls in plant cells, such as the onion cells seen here. (Umberto Salvagnin)</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_01_01_Rosetta.jpg)<caption>The Rosetta spacecraft, with its large and revolutionary solar panels, carried the Philae lander to a comet. The lander then detached and landed on the comet’s surface. (European Space Agency)</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_01_01_solar.jpg)<caption>a) Voyager 2, launched in 1977, used the gravity of Saturn to slingshot over to Uranus and Neptune. NASA b) A rendering of Voyager 1, the first space probe to ever leave our solar system and enter interstellar space. NASA</caption>
