...
* <math><mover accent="true"><mi>a</mi>
<mo>¯</mo></mover></math>, means *average*
...
<equation id="fs-idm11502816" class="unnumbered"><label /> <math>
 <mrow>
  <mover accent="true">
   <mi>a</mi>
   <mo>¯</mo>
...
<equation id="eip-id1164353575976"><label /> <math>
 <mrow>
  <mfrac>
   <mrow>
    <mtext>30</mtext><mtext>.0 km</mtext>
   </mrow>
   <mtext>h</mtext>
  </mfrac>
  <mtext> × </mtext><mfrac>
  ...
  <mtext> = 8</mtext><mtext>.333 </mtext><mfrac>
   <mtext>m</mtext>
   <mtext>s</mtext>
  </mfrac>
...
3. <math>
 <mrow>
  ...
  <mtext>= 8</mtext><mtext>.333 m/s – 0 = + 8</mtext><mtext>.333 m/s,</mtext>
 </mrow>
</math>
...
<equation id="fs-idp50157200"><label /> <math>
 <mrow>
  <mover accent="true">
   <mi>a</mi>
   <mo>¯</mo>
  ...
  <mo>=</mo><mfrac>
   <mrow>
    <mn>8.333</mn><mspace width="0.3em" /><mtext>m/s</mtext>
   </mrow>
   <mrow>
    <mn>20.00</mn><mspace width="0.3em" /><mtext>s</mtext>
   </mrow>
  </mfrac>
  <mo>=</mo><mo>+</mo><mn>0.417</mn><mfrac>
   <mtext>m</mtext>
   <mrow>
    <msup>
     <mtext>s</mtext>
...
<mo>=</mo><mn>0</mn><mo>−</mo><mn>8.333</mn><mspace width="0.3em" /><mtext>m/s</mtext><mo>=</mo><mo>−</mo><mn>8.333</mn><mspace width="0.3em" /><mtext>m/s,</mtext>
 </mrow>
</math>  where the minus sign means that the change in velocity points to the left.
4. We know Δ*t* = 8.00 s, so all we have to do is insert the known values into the equation for average acceleration.

<equation id="fs-idp39523872"><label /> <math>
 <mrow>
  <mover accent="true">
   <mi>a</mi>
   <mo>¯</mo>
  ...
  <mo>=</mo><mfrac>
   <mrow>
    <mo>−</mo><mn>8.333</mn><mspace width="0.3em" /><mtext>m/s</mtext>
   </mrow>
   <mrow>
    <mn>8.00</mn><mspace width="0.3em" /><mtext>s</mtext>
   </mrow>
  </mfrac>
  <mo>=</mo><mo>−</mo><mn>1.04</mn><mfrac>
   <mtext>m</mtext>
   <mrow>
    <msup>
     <mtext>s</mtext>
...
> In this lab you will take measurements to determine if the acceleration of a moving bicycle is constant. If the acceleration is constant, then the following relationships hold:  <math>
>  <mrow>
>   <mover accent="true">
>    <mi>v</mi>
>    <mo>¯</mo>
