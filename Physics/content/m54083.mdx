...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_01_02_electron.jpg)<p>The electron cloud model of the atom predicts the geometry and shape of areas where different electrons may be found in an atom. However, it cannot indicate exactly where an electron will be at any one time.</p>
