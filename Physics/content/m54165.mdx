...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_05_01_city.jpg)<caption>A person walks nine blocks east and five blocks north. The displacement is 10.3 blocks at an angle </caption>
...
1. Let the *x*-axis represent the east-west direction. Using a ruler and protractor, draw an arrow to represent the first vector (nine blocks to the east), as shown in [Figure 05 01 vectora](Figure_05_01_vectora)[Figure 05 01 vectora](Figure_05_01_vectora).
        ![Temp alt text](__MEDIA_URL__CNX_HSPhysics_05_01_vector(a).jpg)<caption>The diagram shows a vector with a magnitude of nine units and a direction of 0°.</caption>
...
2. Let the *y*-axis represent the north-south direction. Draw an arrow to represent the second vector (five blocks to the north). Place the tail of the second vector at the head of the first vector, as shown in [Figure 05 01 vectorb](Figure_05_01_vectorb)[Figure 05 01 vectorb](Figure_05_01_vectorb).
        ![Temp alt text](__MEDIA_URL__CNX_HSPhysics_05_01_vector(b).jpg)<caption>A vertical vector is added.</caption>
...
4. Draw an arrow from the tail of the first vector to the head of the last vector, as shown in [Figure 05 01 vectorc](Figure_05_01_vectorc)[Figure 05 01 vectorc](Figure_05_01_vectorc). This is the **resultant**, or the sum, of the vectors.
        ![Temp alt text](__MEDIA_URL__CNX_HSPhysics_05_01_vector(c).jpg)<caption>The diagram shows the resultant vector, a ruler, and protractor.</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_05_01_negative.jpg)<caption>The diagram shows a vector, B, and the negative of this vector, –B.</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_05_01_skaters.jpg)<caption>Part (a) shows an overhead view of two ice skaters pushing on a third. Forces are vectors and add like vectors, so the total force on the third skater is in the direction shown. In part (b), we see a free-body diagram representing the forces acting on the third skater.</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_05_01_displace.jpg)<caption>The three displacement vectors are drawn first.</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_05_01_tall.jpg)<caption>Next, the vectors are placed head to tail.</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_05_01_result.jpg)<caption>The resultant vector is drawn .</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_05_01_measure.jpg)<caption>A ruler is used to measure the magnitude of </caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_05_01_alt.jpg)<caption>Vectors can be added in any order to get the same result.</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_05_01_magnitude.jpg)<caption>In the diagram, the first leg of the trip is represented by vector A and the second leg is represented by vector B.</caption>
## Strategy
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_05_01_inclined.jpg)<caption>Vector –B represents traveling in the opposite direction of vector B.</caption>
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_05_01_connected.jpg)<caption>The vectors are placed head to tail.</caption>
In this case
...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_05_01_river.jpg)<caption>A boat attempts to travel across a river. What is the total velocity and direction of the boat?</caption>
## Solution
