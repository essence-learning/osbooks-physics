...
## Key Equations
<table><tr><td>electric current *I* is the charge    that passes a plane per unit time</td><td></td></tr><tr><td>an ampere is the coulombs per unit time that pass a plane</td><td></td></tr><tr><td>Ohm’s law: the current *I* is proportional to the voltage *V*, with the resistance *R* being the constant of proportionality</td><td></td></tr></table>
## Concept Items
