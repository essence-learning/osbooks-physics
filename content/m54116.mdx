...
## Key Equations
<table><tr><td>Average velocity</td>    <td>, or    when *d* = 0</td></tr>  <tr><td>Average velocity</td>    <td></td></tr>  <tr><td>Velocity with constant acceleration</td>    <td>, or  when *v* = 0</td></tr>  <tr><td>Displacement with constant acceleration</td>    <td>, or    when *d* = 0 and *v* = 0</td></tr>  <tr><td>Constant acceleration</td>    <td>, or    when *d* = 0 and *v* = 0</td></tr></table>
## Concept Items
