...
where **F** is the net external force,    is the change in momentum, and    is the change in time.
...
> 
> Airbags allow the net force on the occupants in the car to act over a much longer time when there is a sudden stop. The momentum change is the same for an occupant whether an airbag is deployed or not. But the force that brings the occupant to a stop will be much less if it acts over a larger time. By rearranging the equation for impulse to solve for force    you can see how increasing    while    stays the same will decrease **F**. This is another example of an inverse relationship. Similarly, a padded dashboard increases the time over which the force of impact acts, thereby reducing the force of impact.
> 
...
## Key Equations
<table><tr><td>impulse</td><td></td></tr><tr><td>impulse–momentum theorem</td><td></td></tr><tr><td>linear momentum</td><td></td></tr><tr><td>Newton’s second law in terms of momentum</td><td></td></tr></table>
## Concept Items
