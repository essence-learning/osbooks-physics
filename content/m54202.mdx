...
## Key Equations
<table><tr><td>law of conservation of momentum</td><td>**p** = constant, or **p** = **p**′</td></tr><tr><td>conservation of momentum for two objects</td><td>**p** + **p** = constant, or **p** + **p** = **p**′ + **p**′</td></tr><tr><td>angular momentum</td><td>**L** = *I*</td></tr></table>
## Concept Items
