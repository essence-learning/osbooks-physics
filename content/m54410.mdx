...
> 
> Millikan and Fletcher found that the drops would accumulate charge in discrete units of about    which is within 1 percent of the modern value of   Although this difference may seem quite small, it is actually five times greater than the possible error Millikan reported for his results!
> 
...
where    is the net charge of the system before the interaction, and    is the net charge after the interaction.
