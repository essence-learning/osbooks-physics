...
In addition to amplitude, frequency, and period, their wavelength and wave velocity also characterize waves. The   <math> <mi>λ</mi></math>  is the distance between adjacent identical parts of a wave, parallel to the direction of propagation. The   is the distance between adjacent identical parts of a wave, parallel to the direction of propagation. The   <math> <mrow>  <msub>   <mi>v</mi>   <mi>w</mi>  </msub> </mrow></math>  is the speed at which the disturbance moves.  is the speed at which the disturbance moves.
...
## Key Equations
<table><tr><td>wave velocity</td><td><math> <mrow>  <msub>   <mi>v</mi>   <mtext>w</mtext>  </msub>  <mo>=</mo><mfrac>   <mi>λ</mi>   <mi>T</mi>  </mfrac> </mrow></math>  or    or  <math> <mrow>  <msub>   <mi>v</mi>   <mtext>w</mtext>  </msub>  <mo>=</mo><mi>f</mi><mi>λ</mi> </mrow></math></td></tr><tr><td>period</td><td><math> <mrow>  <mi>T</mi><mo>=</mo><mfrac>   <mn>1</mn>   <mi>f</mi>  </mfrac> </mrow></math></td></tr><tr><td>frequency</td><td><math> <mrow>  <mi>f</mi><mo>=</mo><mfrac>   <mn>1</mn>   <mi>T</mi>  </mfrac> </mrow></math></td></tr></table>
## Concept Items
