...
> * Measure the distance from the CD to the wall and the distance from the center of the circular pattern to a color in the rainbow. Use those two distances to calculate  <math> <mrow>  <mi>tan</mi><mi>θ</mi></mrow></math> . Find   . Find  <math> <mrow>  <mtext>sin</mtext><mi>θ</mi></mrow></math> . .
> * Look up the wavelength of the color you chose. That is  <math> <mi>λ</mi></math> . .
> * Solve  <math> <mrow>  <mi>d</mi><mi>sin</mi><mi>θ</mi><mo>=</mo><mi>m</mi><mi>λ</mi></mrow></math>  for   for *d*.
...
> 
> 
Just what is the resolution limit of an aperture or lens? To answer that question, consider the diffraction pattern for a circular aperture, which, similar to the diffraction pattern of light passing through a slit, has a central maximum that is wider and brighter than the maxima surrounding it (see [Figure 7](#Figure_17_02_Resolution) (a)). It can be shown that, for a circular aperture of diameter *D*, the first minimum in the diffraction pattern occurs at  <math> <mrow>  <mi>θ</mi><mo>=</mo><mn>1.22</mn><mi>λ</mi><mo>/</mo><mi>D</mi></mrow></math>, provided that the aperture is large compared with the wavelength of light, which is the case for most optical instruments. The accepted criterion for determining the diffraction limit to resolution based on diffraction was developed by Lord Rayleigh in the 19th century. The , provided that the aperture is large compared with the wavelength of light, which is the case for most optical instruments. The accepted criterion for determining the diffraction limit to resolution based on diffraction was developed by Lord Rayleigh in the 19th century. The  for the diffraction limit to resolution states that two images are just resolvable when the center of the diffraction pattern of one is directly over the first minimum of the diffraction pattern of the other. See [Figure 8](#Figure_17_02_Resolution2) (b). The first minimum is at an angle of  <math> <mrow>  <mi>θ</mi><mo>=</mo><mn>1.22</mn><mi>λ</mi><mo>/</mo><mi>D</mi></mrow></math>, so that two point objects are just resolvable if they are separated by the angle, so that two point objects are just resolvable if they are separated by the angle
