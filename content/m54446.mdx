...
## Key Equations
<table><tr><td>for a given current *I* flowing through a potential difference*V*, the electric power dissipated</td><td></td></tr><tr><td>for a given current *I* flowing through a resistance *R*, the electric power dissipated</td><td></td></tr><tr><td>for a given voltage difference *V* across a resistor *R*, the electric power dissipated</td><td></td></tr></table>
## Concept Items
