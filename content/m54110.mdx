...
Graphs in this text have perpendicular axes, one horizontal and the other vertical. When two physical quantities are plotted against each other, the horizontal axis is usually considered the , and the vertical axis is the . In algebra, you would have referred to the horizontal axis as the *x*-axis and the vertical axis as the *y*-axis. As in [Figure 1](#Figure_02_03_graph), a straight-line graph has the general form  <math> <mrow>  <mi>y</mi><mo>=</mo><mi>m</mi><mi>x</mi><mo>+</mo><mi>b</mi> </mrow></math> . .
