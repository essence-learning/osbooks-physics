# Introduction
![An ocean whitecap crashes near two surfers and three boats.__ALT__Figure_13_00_Ocean](__MEDIA_URL__CNX_HSPhysics_13_00_Ocean.jpg)
***Figure 1** Waves in the ocean behave similarly to all other types of waves. (Steve Jurveston, Flickr)*
