...
***Figure 1** All points on a CD travel in circular paths. The pits (dots) along a line from the center to the edge all move through the same angle  <math> <mrow>  <mtext>Δ</mtext><mi>θ</mi> </mrow></math>  in time    in time  <math> <mrow>  <mtext>Δ</mtext><mi>t</mi> </mrow></math> . .*
...
***Figure 2** The radius (*r*) of a circle is rotated through an angle  <math> <mrow>  <mtext>Δ</mtext><mi>θ</mi> </mrow></math> . The arc length,   . The arc length,  <math> <mrow>  <mtext>Δ</mtext><mi>s</mi> </mrow></math>, is the distance covered along the circumference., is the distance covered along the circumference.*
...
1 revolution =  <math> <mrow>  <mn>2</mn><mi>π</mi> </mrow></math> rad = 360°. See  rad = 360°. See [Figure __REPLACE_Table_06_01__](#Table_06_01) for the conversion of degrees to radians for some common angles.
...
<table><tr><td><math> <mrow>  <msup>   <mrow>    <mn>30</mn>   </mrow>   <mo>∘</mo>  </msup> </mrow></math></td><td><math> <mrow>  <mfrac>   <mi>π</mi>   <mn>6</mn>  </mfrac> </mrow></math></td></tr><tr><td><math> <mrow>  <msup>   <mrow>    <mn>60</mn>   </mrow>   <mo>∘</mo>  </msup> </mrow></math></td><td><math> <mrow>  <mfrac>   <mi>π</mi>   <mn>3</mn>  </mfrac> </mrow></math></td></tr><tr><td><math> <mrow>  <msup>   <mrow>    <mn>90</mn>   </mrow>   <mo>∘</mo>  </msup> </mrow></math></td><td><math> <mrow>  <mfrac>   <mi>π</mi>   <mn>2</mn>  </mfrac> </mrow></math></td></tr><tr><td><math> <mrow>  <msup>   <mrow>    <mn>120</mn>   </mrow>   <mo>∘</mo>  </msup> </mrow></math></td><td><math> <mrow>  <mfrac>   <mrow>    <mn>2</mn><mi>π</mi>   </mrow>   <mn>3</mn>  </mfrac> </mrow></math></td></tr><tr><td><math> <mrow>  <msup>   <mrow>    <mn>135</mn>   </mrow>   <mo>∘</mo>  </msup> </mrow></math></td><td><math> <mrow>  <mfrac>   <mrow>    <mn>3</mn><mi>π</mi>   </mrow>   <mn>4</mn>  </mfrac> </mrow></math></td></tr><tr><td><math> <mrow>  <msup>   <mrow>    <mn>180</mn>   </mrow>   <mo>∘</mo>  </msup> </mrow></math></td><td><math> <mi>π</mi></math></td></tr></table>
## Angular Velocity
...
Angular velocity (ω) is the angular version of linear velocity **v**.  is the instantaneous linear velocity of an object in rotational motion**.**To get the precise relationship between angular velocity and tangential velocity, consider again a pit on the rotating CD. This pit moves through an arc length  <math display="block">   <mrow>   <mo stretchy="false">(</mo><mi>Δ</mi><mi>s</mi><mo stretchy="false">)</mo>  </mrow> </math>  in a   in a *short* time  <math display="block">   <mrow>   <mo stretchy="false">(</mo><mi>Δ</mi><mi>t</mi><mo stretchy="false">)</mo>  </mrow> </math>  so its tangential   so its tangential *speed* is
...
***Figure 3** Points 1 and 2 rotate through the same angle ( <math> <mrow>  <mtext>Δ</mtext><mi>θ</mi> </mrow></math> ), but point 2 moves through a greater arc length (  ), but point 2 moves through a greater arc length ( <math> <mrow>  <mtext>Δ</mtext><msub>   <mi>s</mi>   <mn>2</mn>  </msub> </mrow></math> ) because it is farther from the center of rotation. ) because it is farther from the center of rotation.*
...
***Figure 4** A car moving at a velocity, **v,** to the right has a tire rotating with angular velocity  <math> <mstyle mathvariant="bold" mathsize="normal"><mi>ω</mi></mstyle></math> . The speed of the tread of the tire relative to the axle is  . The speed of the tread of the tire relative to the axle is *v*, the same as if the car were jacked up and the wheels spinning without touching the road. Directly below the axle, where the tire touches the road, the tire tread moves backward with respect to the axle with tangential velocity  <math> <mrow>  <mi>v</mi><mo>=</mo><mi>r</mi><mi>ω</mi> </mrow></math>, where , where *r*is the tire radius. Because the road is stationary with respect to this point of the tire, the car must move forward at the linear velocity **v**. A larger angular velocity for the tire means a greater linear velocity for the car.*
