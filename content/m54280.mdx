...
![Temp alt text](__MEDIA_URL__CNX_HSPhysics_10_00_Einstein.jpg)<p>Albert Einstein (1879–1955) developed modern relativity and also made fundamental contributions to the foundations of quantum mechanics. (The Library of Congress)</p>
...
1. It travels at a speed of *c* + 200 m/s.
2. It travels at a speed of *c*  200 m/s.
3. It travels at a speed *c*, like all light.
4. It travels at a speed slightly less than *c*.
...
> 5. The frequency of the waves is written on the back of the microwave. Look for something like “2,450 MHz.” Hz is the unit hertz, which means *per second*. The M represents mega, which stands for million, so multiply the number by 10<sup>6</sup>.
...
> 
> 1. The measured value of speed will be equal to *c*.
> 2. The measured value of speed will be slightly less than *c*.
> 3. The measured value of speed will be slightly greater than *c*.
...
Now suppose we use this method to measure the time interval between two flashes of light produced by flash lamps on a moving train. (See [Figure 10 01 train](Figure_10_01_train))

![Temp alt text](__MEDIA_URL__CNX_HSPhysics_10_01_train.jpg)<p>Light arriving to observer A as seen by two different observers.</p>
...
In this chapter, you will learn about the theory of special relativity, but, as mentioned in the introduction, Einstein developed two relativity theories: special and general. [Table 10 01 relativity](Table_10_01_relativity) summarizes the differences between the two theories.
...
1. 4.42×10<sup>-9</sup> m/s
2. 4.42×10<sup>9</sup> m/s
3. 2.26×10<sup>8</sup> m/s
4. 226×10<sup>8</sup> m/s
...
1. 2.34×10<sup>5</sup> km
2. 2.34×10<sup>8</sup> km
3. 3.84×10<sup>5</sup> km
4. 3.84×10<sup>8</sup> km
...
4. The speed of light in vacuum is less than 3.00×10<sup>8</sup> m/s.
...
1. 1. Earth is at rest and the sun orbits Earth.
...
1. 5.6×10<sup>7</sup> km
2. 5.6×10<sup>10</sup> km
3. 6.2×10<sup>6</sup> km
4. 6.2×10<sup>12</sup> km
...
4. Light always travels in a vacuum with a speed less than 3.00×10<sup>8</sup> m/s, regardless of the speed of the source.
