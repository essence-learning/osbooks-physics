...
## Section Key Terms
<table><tr><td>binding energy</td>
            <td>length contraction</td>
            <td>mass defect</td>
            <td>time dilation</td></tr>
          <tr><td>proper length</td>
            <td>relativistic</td>
            <td>relativistic momentum</td>
            <td></td></tr>
          <tr><td>relativistic energy</td>
...
***Figure 1** (a) An astronaut measures the time  for light to cross her ship using an electronic timer. Light travels a distance  in the astronaut’s frame. (b) A person on the earth sees the light follow the longer path  and take a longer time*


The relationship between Δ*t* and Δ*t* is given by


where  is the  given by


and *v* and *c* are the speeds of the moving observer and light, respectively.

> Try putting some values for *v* into the expression for the relativistic factor (  ). Observe at which speeds this factor will make a difference and when  is so close to 1 that it can be ignored. Try 225 m/s, the speed of an airliner; 2.98 × 10<sup>4</sup> m/s, the speed of Earth in its orbit; and 2.990 × 10<sup>8</sup> m/s, the speed of a particle in an accelerator.
...
where  is the  of the object (that is, the mass measured at rest, without any  factor involved),  is its velocity relative to an observer, and 
...
Relativistic momentum has the same intuitive feel as classical momentum. It is greatest for large masses moving at high velocities. Because of the factor  however, relativistic momentum behaves differently from classical momentum by approaching infinity as  approaches   (See [Figure 3](#Figure_10_02_speed).) This is another indication that an object with mass cannot reach the speed of light. If it did, its momentum would become infinite, which is an unreasonable value.
...
### Time Dilation
Elapsed time on a moving object,   as seen by a stationary observer is given by  where  is the time observed on the moving object when it is taken to be the frame or reference.
...
Momentum, **p**, of an object of mass, *m*, traveling at relativistic speeds is given by   where **u** is velocity of a moving object as seen by a stationary observer.
...
This is the expression for the  of an object of mass *m* at any speed **u** and includes both  and . Look back at the equation for  and you will see that it is equal to 1 when **u** is 0; that is, when an object is at rest. Then the rest energy, *E*, is simply
...
## Key Equations
<table><tr><td>elapsed time</td>
          <td></td></tr>
        <tr><td>relativistic factor</td>
          <td></td></tr>
        <tr><td>length contraction</td>
          <td></td></tr>
        <tr><td>relativistic momentum</td>
          <td></td></tr>
        <tr><td>relativistic energy</td>
          <td></td></tr>
        <tr><td>rest energy</td>
          <td></td></tr></table>
## Concept Items
