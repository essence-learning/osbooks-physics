...
## Solution
1. 1. Analyze the shape of the area to be calculated. In this case, the area is made up of a rectangle between 0 and 20 m/s stretching to 30 s. The area of a rectangle is length  <math><mo>×</mo></math>  width. Therefore, the area of this piece is 600 m.  width. Therefore, the area of this piece is 600 m.
...
2. 1. Take two points on the velocity line. Say, *t* = 5 s and *t* = 25 s. At *t* = 5 s, the value of *v* = 40 m/s. At *t* = 25 s, *v* = 140 m/s.
