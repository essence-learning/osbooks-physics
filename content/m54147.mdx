...
## Key Equations
<table><tr><td>resultant magnitude</td>            <td></td></tr>          <tr><td>resultant direction</td>            <td></td></tr>          <tr><td>x-component of a vector A (when an angle is given relative to the horizontal)</td>            <td></td></tr>          <tr><td>y-component of a vector A (when an angle is given relative to the horizontal)</td>            <td></td></tr>          <tr><td>addition of vectors</td>            <td></td></tr></table>
